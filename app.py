...
if st.button("🚀 Buat Jadwal Menu!", type="primary"):
   with st.spinner("Agen sedang berdiskusi dan mesin AI sedang menghitung kombinasi menu..."):
        
        # 1. JALANKAN AGEN SISA MAKANAN
        adjusted_leftover_dict, laporan_waste = waste_agent.analyze(df_leftover, leftover_dict)
        
        # Tampilkan laporan agen langsung di layar UI Streamlit
        st.info(laporan_waste)
        
        # 2. MULAI OPTIMASI MATEMATIS
        ...
        # ================================
        # OBJECTIVE FUNCTION (MENGGUNAKAN HASIL AGEN)
        # ================================
        model += lpSum(
            biaya_dict[i] * N_SISWA * x[i][t]
            # PERHATIKAN: Kita pakai adjusted_leftover_dict dari Agen, bukan yang asli!
